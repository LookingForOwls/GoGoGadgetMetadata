...
// ADMINMINT is a free data retrieval call binding the contract method 0x98da7446.
//
// Solidity: function ADMIN_MINT() view returns(uint256)
func (_Storage *StorageCaller) ADMINMINT(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Storage.contract.Call(opts, &out, "ADMIN_MINT")
...
//
// Solidity: function ADMIN_MINT() view returns(uint256)
func (_Storage *StorageSession) ADMINMINT() (*big.Int, error) {
	return _Storage.Contract.ADMINMINT(&_Storage.CallOpts)
}

// ADMINMINT is a free data retrieval call binding the contract method 0x98da7446.
//
// Solidity: function ADMIN_MINT() view returns(uint256)
func (_Storage *StorageCallerSession) ADMINMINT() (*big.Int, error) {
	return _Storage.Contract.ADMINMINT(&_Storage.CallOpts)
}

// MAXMINT is a free data retrieval call binding the contract method 0xf0292a03.
//
// Solidity: function MAX_MINT() view returns(uint256)
func (_Storage *StorageCaller) MAXMINT(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Storage.contract.Call(opts, &out, "MAX_MINT")
...
//
// Solidity: function MAX_MINT() view returns(uint256)
func (_Storage *StorageSession) MAXMINT() (*big.Int, error) {
	return _Storage.Contract.MAXMINT(&_Storage.CallOpts)
}

// MAXMINT is a free data retrieval call binding the contract method 0xf0292a03.
//
// Solidity: function MAX_MINT() view returns(uint256)
func (_Storage *StorageCallerSession) MAXMINT() (*big.Int, error) {
	return _Storage.Contract.MAXMINT(&_Storage.CallOpts)
}

// MINTLIMIT is a free data retrieval call binding the contract method 0x02775240.
//
// Solidity: function MINT_LIMIT() view returns(uint8)
func (_Storage *StorageCaller) MINTLIMIT(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _Storage.contract.Call(opts, &out, "MINT_LIMIT")
...
//
// Solidity: function MINT_LIMIT() view returns(uint8)
func (_Storage *StorageSession) MINTLIMIT() (uint8, error) {
	return _Storage.Contract.MINTLIMIT(&_Storage.CallOpts)
}

// MINTLIMIT is a free data retrieval call binding the contract method 0x02775240.
//
// Solidity: function MINT_LIMIT() view returns(uint8)
func (_Storage *StorageCallerSession) MINTLIMIT() (uint8, error) {
	return _Storage.Contract.MINTLIMIT(&_Storage.CallOpts)
}
...
func (_Storage *StorageCaller) MINTPRICE(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Storage.contract.Call(opts, &out, "MINT_PRICE")
...
//
// Solidity: function MINT_PRICE() view returns(uint256)
func (_Storage *StorageSession) MINTPRICE() (*big.Int, error) {
	return _Storage.Contract.MINTPRICE(&_Storage.CallOpts)
}

// MINTPRICE is a free data retrieval call binding the contract method 0xc002d23d.
//
// Solidity: function MINT_PRICE() view returns(uint256)
func (_Storage *StorageCallerSession) MINTPRICE() (*big.Int, error) {
	return _Storage.Contract.MINTPRICE(&_Storage.CallOpts)
}
...
func (_Storage *StorageCaller) TOTALSUPPLY(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Storage.contract.Call(opts, &out, "TOTAL_SUPPLY")
...
func (_Storage *StorageCaller) AdminWallet(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Storage.contract.Call(opts, &out, "adminWallet")
...
//
// Solidity: function adminWallet() view returns(address)
func (_Storage *StorageSession) AdminWallet() (common.Address, error) {
	return _Storage.Contract.AdminWallet(&_Storage.CallOpts)
}

// AdminWallet is a free data retrieval call binding the contract method 0x36b19cd7.
//
// Solidity: function adminWallet() view returns(address)
func (_Storage *StorageCallerSession) AdminWallet() (common.Address, error) {
	return _Storage.Contract.AdminWallet(&_Storage.CallOpts)
}
...
func (_Storage *StorageCaller) BaseURI(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Storage.contract.Call(opts, &out, "baseURI")
...
//
// Solidity: function baseURI() view returns(string)
func (_Storage *StorageSession) BaseURI() (string, error) {
	return _Storage.Contract.BaseURI(&_Storage.CallOpts)
}

// BaseURI is a free data retrieval call binding the contract method 0x6c0360eb.
//
// Solidity: function baseURI() view returns(string)
func (_Storage *StorageCallerSession) BaseURI() (string, error) {
	return _Storage.Contract.BaseURI(&_Storage.CallOpts)
}
...
func (_Storage *StorageCaller) GetApproved(opts *bind.CallOpts, tokenId *big.Int) (common.Address, error) {
	var out []interface{}
	err := _Storage.contract.Call(opts, &out, "getApproved", tokenId)
...
//
// Solidity: function getApproved(uint256 tokenId) view returns(address)
func (_Storage *StorageSession) GetApproved(tokenId *big.Int) (common.Address, error) {
	return _Storage.Contract.GetApproved(&_Storage.CallOpts, tokenId)
}

// GetApproved is a free data retrieval call binding the contract method 0x081812fc.
//
// Solidity: function getApproved(uint256 tokenId) view returns(address)
func (_Storage *StorageCallerSession) GetApproved(tokenId *big.Int) (common.Address, error) {
	return _Storage.Contract.GetApproved(&_Storage.CallOpts, tokenId)
}
...
func (_Storage *StorageCaller) IsApprovedForAll(opts *bind.CallOpts, owner common.Address, operator common.Address) (bool, error) {
	var out []interface{}
	err := _Storage.contract.Call(opts, &out, "isApprovedForAll", owner, operator)
...
//
// Solidity: function isApprovedForAll(address owner, address operator) view returns(bool)
func (_Storage *StorageSession) IsApprovedForAll(owner common.Address, operator common.Address) (bool, error) {
	return _Storage.Contract.IsApprovedForAll(&_Storage.CallOpts, owner, operator)
}

// IsApprovedForAll is a free data retrieval call binding the contract method 0xe985e9c5.
//
// Solidity: function isApprovedForAll(address owner, address operator) view returns(bool)
func (_Storage *StorageCallerSession) IsApprovedForAll(owner common.Address, operator common.Address) (bool, error) {
	return _Storage.Contract.IsApprovedForAll(&_Storage.CallOpts, owner, operator)
}
...
// AdminMint is a paid mutator transaction binding the contract method 0x895fc788.
//
// Solidity: function adminMint() returns()
func (_Storage *StorageTransactor) AdminMint(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "adminMint")
}

// AdminMint is a paid mutator transaction binding the contract method 0x895fc788.
//
// Solidity: function adminMint() returns()
func (_Storage *StorageSession) AdminMint() (*types.Transaction, error) {
	return _Storage.Contract.AdminMint(&_Storage.TransactOpts)
}

// AdminMint is a paid mutator transaction binding the contract method 0x895fc788.
//
// Solidity: function adminMint() returns()
func (_Storage *StorageTransactorSession) AdminMint() (*types.Transaction, error) {
	return _Storage.Contract.AdminMint(&_Storage.TransactOpts)
}
...
func (_Storage *StorageTransactor) Approve(opts *bind.TransactOpts, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "approve", to, tokenId)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address to, uint256 tokenId) payable returns()
func (_Storage *StorageSession) Approve(to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.Approve(&_Storage.TransactOpts, to, tokenId)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address to, uint256 tokenId) payable returns()
func (_Storage *StorageTransactorSession) Approve(to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.Approve(&_Storage.TransactOpts, to, tokenId)
}

// FreezeBaseURI is a paid mutator transaction binding the contract method 0xe7bc8208.
//
// Solidity: function freezeBaseURI() returns()
func (_Storage *StorageTransactor) FreezeBaseURI(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "freezeBaseURI")
}

// FreezeBaseURI is a paid mutator transaction binding the contract method 0xe7bc8208.
//
// Solidity: function freezeBaseURI() returns()
func (_Storage *StorageSession) FreezeBaseURI() (*types.Transaction, error) {
	return _Storage.Contract.FreezeBaseURI(&_Storage.TransactOpts)
}

// FreezeBaseURI is a paid mutator transaction binding the contract method 0xe7bc8208.
//
// Solidity: function freezeBaseURI() returns()
func (_Storage *StorageTransactorSession) FreezeBaseURI() (*types.Transaction, error) {
	return _Storage.Contract.FreezeBaseURI(&_Storage.TransactOpts)
}
...
func (_Storage *StorageTransactor) Mint(opts *bind.TransactOpts, quantity *big.Int) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "mint", quantity)
}

// Mint is a paid mutator transaction binding the contract method 0xa0712d68.
//
// Solidity: function mint(uint256 quantity) payable returns()
func (_Storage *StorageSession) Mint(quantity *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.Mint(&_Storage.TransactOpts, quantity)
}

// Mint is a paid mutator transaction binding the contract method 0xa0712d68.
//
// Solidity: function mint(uint256 quantity) payable returns()
func (_Storage *StorageTransactorSession) Mint(quantity *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.Mint(&_Storage.TransactOpts, quantity)
}
...
func (_Storage *StorageTransactor) SafeTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "safeTransferFrom", from, to, tokenId)
}

// SafeTransferFrom is a paid mutator transaction binding the contract method 0x42842e0e.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId) payable returns()
func (_Storage *StorageSession) SafeTransferFrom(from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.SafeTransferFrom(&_Storage.TransactOpts, from, to, tokenId)
}

// SafeTransferFrom is a paid mutator transaction binding the contract method 0x42842e0e.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId) payable returns()
func (_Storage *StorageTransactorSession) SafeTransferFrom(from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.SafeTransferFrom(&_Storage.TransactOpts, from, to, tokenId)
}
...
func (_Storage *StorageTransactor) SafeTransferFrom0(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int, _data []byte) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "safeTransferFrom0", from, to, tokenId, _data)
}

// SafeTransferFrom0 is a paid mutator transaction binding the contract method 0xb88d4fde.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes _data) payable returns()
func (_Storage *StorageSession) SafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, _data []byte) (*types.Transaction, error) {
	return _Storage.Contract.SafeTransferFrom0(&_Storage.TransactOpts, from, to, tokenId, _data)
}

// SafeTransferFrom0 is a paid mutator transaction binding the contract method 0xb88d4fde.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes _data) payable returns()
func (_Storage *StorageTransactorSession) SafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, _data []byte) (*types.Transaction, error) {
	return _Storage.Contract.SafeTransferFrom0(&_Storage.TransactOpts, from, to, tokenId, _data)
}

// SetAdminWallet is a paid mutator transaction binding the contract method 0x35082933.
//
// Solidity: function setAdminWallet(address _adminWallet) returns()
func (_Storage *StorageTransactor) SetAdminWallet(opts *bind.TransactOpts, _adminWallet common.Address) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "setAdminWallet", _adminWallet)
}

// SetAdminWallet is a paid mutator transaction binding the contract method 0x35082933.
//
// Solidity: function setAdminWallet(address _adminWallet) returns()
func (_Storage *StorageSession) SetAdminWallet(_adminWallet common.Address) (*types.Transaction, error) {
	return _Storage.Contract.SetAdminWallet(&_Storage.TransactOpts, _adminWallet)
}

// SetAdminWallet is a paid mutator transaction binding the contract method 0x35082933.
//
// Solidity: function setAdminWallet(address _adminWallet) returns()
func (_Storage *StorageTransactorSession) SetAdminWallet(_adminWallet common.Address) (*types.Transaction, error) {
	return _Storage.Contract.SetAdminWallet(&_Storage.TransactOpts, _adminWallet)
}
...
func (_Storage *StorageTransactor) SetApprovalForAll(opts *bind.TransactOpts, operator common.Address, approved bool) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "setApprovalForAll", operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_Storage *StorageSession) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _Storage.Contract.SetApprovalForAll(&_Storage.TransactOpts, operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_Storage *StorageTransactorSession) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _Storage.Contract.SetApprovalForAll(&_Storage.TransactOpts, operator, approved)
}
...
func (_Storage *StorageTransactor) SetBaseURI(opts *bind.TransactOpts, _newBaseURI string) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "setBaseURI", _newBaseURI)
}

// SetBaseURI is a paid mutator transaction binding the contract method 0x55f804b3.
//
// Solidity: function setBaseURI(string _newBaseURI) returns()
func (_Storage *StorageSession) SetBaseURI(_newBaseURI string) (*types.Transaction, error) {
	return _Storage.Contract.SetBaseURI(&_Storage.TransactOpts, _newBaseURI)
}

// SetBaseURI is a paid mutator transaction binding the contract method 0x55f804b3.
//
// Solidity: function setBaseURI(string _newBaseURI) returns()
func (_Storage *StorageTransactorSession) SetBaseURI(_newBaseURI string) (*types.Transaction, error) {
	return _Storage.Contract.SetBaseURI(&_Storage.TransactOpts, _newBaseURI)
}
...
func (_Storage *StorageTransactor) TransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "transferFrom", from, to, tokenId)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address from, address to, uint256 tokenId) payable returns()
func (_Storage *StorageSession) TransferFrom(from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.TransferFrom(&_Storage.TransactOpts, from, to, tokenId)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address from, address to, uint256 tokenId) payable returns()
func (_Storage *StorageTransactorSession) TransferFrom(from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.TransferFrom(&_Storage.TransactOpts, from, to, tokenId)
}
...
func (_Storage *StorageTransactor) WithdrawFunds(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "withdrawFunds")
}

// WithdrawFunds is a paid mutator transaction binding the contract method 0x24600fc3.
//
// Solidity: function withdrawFunds() returns()
func (_Storage *StorageSession) WithdrawFunds() (*types.Transaction, error) {
	return _Storage.Contract.WithdrawFunds(&_Storage.TransactOpts)
}

// WithdrawFunds is a paid mutator transaction binding the contract method 0x24600fc3.
//
// Solidity: function withdrawFunds() returns()
func (_Storage *StorageTransactorSession) WithdrawFunds() (*types.Transaction, error) {
	return _Storage.Contract.WithdrawFunds(&_Storage.TransactOpts)
}
...
// StorageConsecutiveTransferIterator is returned from FilterConsecutiveTransfer and is used to iterate over the raw logs and unpacked data for ConsecutiveTransfer events raised by the Storage contract.
type StorageConsecutiveTransferIterator struct {
	Event *StorageConsecutiveTransfer // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *StorageConsecutiveTransferIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(StorageConsecutiveTransfer)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *StorageConsecutiveTransferIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *StorageConsecutiveTransferIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// StorageConsecutiveTransfer represents a ConsecutiveTransfer event raised by the Storage contract.
type StorageConsecutiveTransfer struct {
	FromTokenId *big.Int
	ToTokenId   *big.Int
	From        common.Address
	To          common.Address
...
func (_Storage *StorageFilterer) FilterConsecutiveTransfer(opts *bind.FilterOpts, fromTokenId []*big.Int, from []common.Address, to []common.Address) (*StorageConsecutiveTransferIterator, error) {
	...
	logs, sub, err := _Storage.contract.FilterLogs(opts, "ConsecutiveTransfer", fromTokenIdRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &StorageConsecutiveTransferIterator{contract: _Storage.contract, event: "ConsecutiveTransfer", logs: logs, sub: sub}, nil
}

// WatchConsecutiveTransfer is a free log subscription operation binding the contract event 0xdeaa91b6123d068f5821d0fb0678463d1a8a6079fe8af5de3ce5e896dcf9133d.
//
// Solidity: event ConsecutiveTransfer(uint256 indexed fromTokenId, uint256 toTokenId, address indexed from, address indexed to)
func (_Storage *StorageFilterer) WatchConsecutiveTransfer(opts *bind.WatchOpts, sink chan<- *StorageConsecutiveTransfer, fromTokenId []*big.Int, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Storage.contract.WatchLogs(opts, "ConsecutiveTransfer", fromTokenIdRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(StorageConsecutiveTransfer)
				if err := _Storage.contract.UnpackLog(event, "ConsecutiveTransfer", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ConsecutiveTransfer(uint256 indexed fromTokenId, uint256 toTokenId, address indexed from, address indexed to)
func (_Storage *StorageFilterer) ParseConsecutiveTransfer(log types.Log) (*StorageConsecutiveTransfer, error) {
	event := new(StorageConsecutiveTransfer)
	if err := _Storage.contract.UnpackLog(event, "ConsecutiveTransfer", log); err != nil {
		return nil, err
	}
